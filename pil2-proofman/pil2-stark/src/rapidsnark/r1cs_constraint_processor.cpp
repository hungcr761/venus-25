...
namespace R1cs
{
    ...
    ConstraintReduceCoefficients R1csConstraintProcessor::reduceCoefs(FflonkSetupSettings &settings,
    ...
    void R1csConstraintProcessor::processR1csMultiplicationConstraint(FflonkSetupSettings &settings,
                                                                      std::vector<R1cs::ConstraintCoefficients> &plonkConstraints,
                                                                      std::vector<R1cs::AdditionCoefficients> &plonkAdditions,
                                                                      vector<R1csConstraint> &lcA,
                                                                      vector<R1csConstraint> &lcB,
