...
int main (int argc, char **argv)
{
    ...
    if (argc != 4)
    {
        cerr << "Error: expected 3 arguments but got " << argc - 1 << " Usage: plonkSetup <r1csFile> <ptauFile> <zkeyFile>" << endl;
        return -1;
    }
    ...
    plonkSetup->generateZkey(r1csFilename, ptauFilename, zkeyFilename);
